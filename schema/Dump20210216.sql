...
CREATE TABLE `book` (
  ...
  `book_publish` varchar(45) DEFAULT NULL,
  `book_categoty_id` int DEFAULT NULL,
  `price` decimal(10,0) DEFAULT NULL,
  `book_introduction` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `borrowing_books` (
  ...
  `borrowing_deadline` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'foo','foo','foo123@gmail.com');
...
-- Dump completed on 2021-02-16 20:04:42
